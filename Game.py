    ...
    #------in Teleporter gelaufen----
        ...
        for v in range(100):
            ...
            if level[heroz][ty][tx] ==".":
               ...
               heroy=ty
               dy=0
               print("Der Teleporter funktioniert und teleportiert dich an den Arsch der Welt")
               break
            else:
                dx=0
                dy=0
                print("Der Teleporter funktioniert nicht und du kannst getrost weitergehen")
        #print("Du wirst von einem Teleporter zurückteleportiert")
